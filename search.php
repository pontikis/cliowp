...
<h1><?php _e('Search results', 'cliowp'); ?></h1>

<h2><?php _e('Search query', 'cliowp'); ?> &ldquo;<?php echo esc_html(get_search_query()); ?>&rdquo;</h2>

<?php if ($count_results): ?>
<h3><?php _e('Results', 'cliowp'); ?> <?php echo $count_results ?></h3>
<?php else: ?>
<h3><?php _e('No results for this query...', 'cliowp'); ?></h3>
<?php endif; ?>
